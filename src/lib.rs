...
pub const DEFAULT_STANDALONE_WASM_URL: &str = "__YAZELIX_ZELLIJ_BAR_ZJSTATUS_WASM__";
...
pub fn generate_standalone_preset(
    ...
    let mut lines = vec![
        ...
        "    // Generated by yazelix_zellij_bar_generate. Edit the options or raw KDL.".to_string(),
        format!(
            "    format_left   \"{}\"",
...
"#,
    ...
    fn standalone_generator_emits_generic_default_preset() {
        ...
        assert!(rendered.contains("plugin location=\"__YAZELIX_ZELLIJ_BAR_ZJSTATUS_WASM__\""));
